...
it('should return expected hidden gems (HttpClient called once)', () => {
  const expectedHiddenGems: HiddenGem[] =
    [ { id: 1, name: 'Fratelli Fresh', business_type: 'restaurant', address: 'ICC Sydney, tenancy 2/14 Darling Dr, Sydney NSW 2000', price_level: 2, rating: 3.6, photo: 'https://cdn.pixabay.com/photo/2017/12/09/08/18/pizza-3007395_960_720.jpg' },
      { id: 2, name: 'Cafe Sydney', business_type: 'cafe', address: '31 Alfred St, Sydney NSW 2000', price_level: 4, rating: 4.5, photo: 'https://cdn.pixabay.com/photo/2015/09/02/12/43/meal-918639_960_720.jpg' }];
...
it('should return an error when the server returns a 404', () => {
  ...
  hiddenGemService.getAllHiddenGems().subscribe(
    hiddenGems => fail('expected an error, not hidden gems'),
